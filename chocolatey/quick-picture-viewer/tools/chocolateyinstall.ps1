...
$url        = 'https://github.com/ModuleArt/quick-picture-viewer/releases/download/v3.0.4/QuickPictureViewer-Setup.exe' # download url, HTTPS preferred
$url64      = 'https://github.com/ModuleArt/quick-picture-viewer/releases/download/v3.0.4/QuickPictureViewer-Setup.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'quick-picture-viewer*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
